...
const PROVINCES: Row[] = [
  { name: "北京", reform: "3+3", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+3 新高考（6 选 3，含技术）。普通本科批 30 个院校专业组志愿，平行投档。强基/综合评价/军校/公安/小语种 走本科提前批。语数外原始分 + 6 选 3 等级赋分，满分 750。" },
  { name: "天津", reform: "3+3", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+3 新高考（6 选 3，等级赋分）。普通本科批 50 个院校专业组志愿，平行投档。提前批 A 段 (军校/公安/飞行学员/公费师范) 顺序志愿，B 段 (五区农村专项) 平行志愿。" },
  { name: "上海", reform: "3+3", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+3 新高考（6 选 3，等级赋分），满分 660。综合评价是上海一大特色，复旦/上交/同济/华东师大/上财/上外/华理 等 14 所校都有综评。院校专业组志愿，平行投档。高分段（>580）投档线不公开。" },
  { name: "重庆", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考。首选物理或历史，再选化学/生物/政治/地理 中选 2 科。院校专业组志愿。本科批 96 个志愿。提前批 含军校/公安/公费师范。" },
  { name: "河北", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
  ...
  { name: "辽宁", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
  ...
  { name: "黑龙江", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考。首选物理/历史 + 再选 2 科。哈工大本部/哈工程/哈深 是省内主要工科去向。" },
  { name: "江苏", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考。首选物理/历史分轨。院校专业组志愿，本科批 40 个志愿。南大/东南综合评价是江苏特色路径。" },
  { name: "浙江", reform: "3+3", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+3 新高考（7 选 3，含技术）。一段线/二段线分段录取。80 个「专业 + 院校」志愿，平行投档。三位一体综合评价 是浙大/复旦/上交/科大等校在浙江独有的招生路径，高考 85% + 校测 10% + 学考 5%。" },
  { name: "安徽", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
  ...
  { name: "山东", reform: "3+3", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
  ...
  { name: "湖北", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考。首选物理/历史分轨。院校专业组志愿。武大/华科/华农/中国地大武汉等是省内顶尖工科去向。" },
  { name: "湖南", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考。首选物理/历史分轨。湖南公费师范 6 校（湖南师大/一师/衡阳师院/湖南文理/吉首/科技）走提前批 + 服务期 6 年。国防科大在湖南有特殊招生。" },
  { name: "广东", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
  ...
  { name: "四川", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
  ...
  { name: "陕西", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考（2025 首届）。首选物理/历史分轨。西交/西工大/西电/长安/陕师大 是省内顶尖去向。陕师大公费师范「红烛计划」是本省师范主力。" },
  { name: "甘肃", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考（2025 首届）。首选物理/历史分轨。兰大是省内唯一 985。农村专项 + 国家专项 + 地方专项 实施面较广。" },
  { name: "青海", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "building",
